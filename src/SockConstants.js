...
export const _EXISTING_USER = 'existing'
export const _CHAT_REQUEST = 'chatting'
export const _STATUS_ONLINE = 'online'
export const _STATUS_OFFLINE = 'offline'
export const _STATUS_TIRED = 'TIRED'
export const _SOCK_SERVER_EXTERNAL = 'http://65.93.174.147:8080/gs-guide-websocket'
export const _SOCK_SERVER = 'http://192.168.2.51:8080/gs-guide-websocket'
